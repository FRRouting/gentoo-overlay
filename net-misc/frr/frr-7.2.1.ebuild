...
IUSE="caps doc elibc_glibc ipv6 +readline +bgp +rip +ospf +ldp +nhrp +eigrp +babel watchfrr +isis +pim +pbr +fabric +snmp +realms systemd fpm rpki multipath pam protobuf shell-access"
REQUIRED_USE="
	rpki? ( bgp )
"
